...
**§ 3 ust. 2** (nowy) - wzmianka, że rywalizacja medalowa kończy się 29.05.2026 o 23:59, z odesłaniem do szczegółów.
...
**§ 9 ust. 3** (przebudowany) - nazwa „nagroda roczna" zmieniona na „medal okolicznościowy", dodane jednoznaczne wyliczenie 12 miesięcy (z zaznaczeniem, że maj to 1–29 maja 2026), data wręczenia 30 maja 2026 wpisana wprost (zamiast samych „Dni Komornik 2026").
...
- Jazda musi się zakończyć do 29.05.2026 23:59 (Europe/Warsaw)
- Aktywność musi być widoczna w Stravie do 29.05.2026 23:59 (wyłączenie 72h okna)
- Aktywności wgrane po terminie, ale spełniające pozostałe warunki, **nadal liczą się do rankingu rocznego i klasyfikacji majowej** - zgodnie z Twoją odpowiedzią
- Lista medalowa zamykana i publikowana 30 maja przed ceremonią
...
**§ 12 ust. 5** (nowy) - termin na reklamacje medalowe: do 12:00 w sobotę 30 maja, żeby dało się je rozpatrzyć przed ceremonią.

**Kompatybilność z systemem:** logika aplikacji nie wymaga zmian dla 99% przypadków - standardowe okno 72h zostaje. Jedyne, co aplikacja musi zrobić ekstra, to przy generowaniu listy medalowej 30 maja zastosować dodatkowy filtr: `activity_end_time <= 2026-05-29 23:59:59 Europe/Warsaw AND strava_upload_time <= 2026-05-29 23:59:59 Europe/Warsaw`. Reszta klasyfikacji (ranking roczny, maj jako miesiąc) używa tych samych zweryfikowanych aktywności bez modyfikacji.
