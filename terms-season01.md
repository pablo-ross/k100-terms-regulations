## Regulamin wydarzenia "KOMORNICKA 100"
### Sezon 2025/2026

### §&nbsp;1 CEL WYDARZENIA

   1. Promocja zdrowego trybu życia poprzez aktywność fizyczną.
   2. Zachęcanie do dłuższych aktywności rowerowych.
   3. Poznawanie interesujących miejsc w okolicy.
   4. Integracja lokalnego środowiska.
   5. Dawanie przykładu dzieciom i młodzieży.
...
2. Partnerzy wydarzenia:
   ...
   Lista aktualnych partnerów jest dostępna na stronie [Partnerzy](/partners).

### §&nbsp;3 TERMIN I MIEJSCE

   1. Wydarzenie rozpoczyna się 1 czerwca 2025 r. i trwa do 31 maja 2026 r.
   2. Rywalizacja o medal okolicznościowy, o którym mowa w §&nbsp;9 ust. 3, kończy się wcześniej, tj. w piątek 29 maja 2026 r. o godz. 23:59. Szczegółowe zasady tej rywalizacji określa §&nbsp;9 ust. 3 oraz §&nbsp;10 ust. 3 Regulaminu.
...
### §&nbsp;4 TRASY
   ...
   1. Wydarzenie odbywa się tylko i wyłącznie na wyznaczonych trasach.
   2. Każda z wyznaczonych tras ma długość około 100 km.
   3. Szczegółowe informacje o wszystkich wyznaczonych trasach, w tym możliwość pobrania plików GPX, są dostępne na stronie [Trasa](/route).
   4. Kierunek jazdy jest określony dla każdej z tras, jednak Uczestnik może pokonać trasę również w przeciwnym kierunku.
   5. Organizator rekomenduje niekorzystanie z roweru typu szosowego.
   6. Organizator zastrzega sobie prawo do modyfikacji przebiegu tras oraz dodawania nowych tras. Informacje o ewentualnych zmianach będą publikowane na stronie internetowej [komornicka100.pl](https://komornicka100.pl) oraz w mediach społecznościowych.
...
### §&nbsp;5 UCZESTNICTWO
   ...
   4. Uczestnicy są zobowiązani do:
      ...
      2. Stosowania się do zaleceń i uwag Organizatora.
      3. Posiadania sprawnego roweru, wyposażonego zgodnie z obowiązującymi przepisami oraz kasku ochronnego.
      4. Zachowania należytej ostrożności.
      5. Przestrzegania zasad ochrony przyrody, szczególnie na terenach Wielkopolskiego Parku Narodowego.
   5. Uczestnicy mają obowiązek bezwzględnego podporządkowania się przepisom ruchu drogowego oraz poleceniom służb porządkowych i Organizatora.
...
### §&nbsp;7 WERYFIKACJA PRZEJECHANYCH TRAS
   ...
   1. Rejestracja przejazdu trasy odbywa się wyłącznie za pośrednictwem strony pod adresem [komornicka100.pl](https://komornicka100.pl) w połączeniu z aplikacją Strava.
   2. Proces weryfikacji przejazdów:
      1. System automatycznie sprawdza konto Strava Uczestnika co kilka godzin, szukając nowych jazd rowerowych.
      2. Weryfikowane są tylko przejazdy oznaczone jako "Ride" (Jazda na rowerze) w Stravie.
      3. Przejazd musi być ustawiony jako "publiczny" w ustawieniach prywatności Stravy.
   ...
   3. Zaliczenie trasy:
      ...
      3. Po potwierdzeniu zaliczenia przejazdu, całkowita liczba zaliczonych aktywności Uczestnika zostanie zaktualizowana.
   4. System Komornicka 100 sprawdza nowe aktywności poprzez Strava API. Po znalezieniu jazdy weryfikacja czasu i trasy następuje niezwłocznie, zazwyczaj w ciągu kilku minut.
   5. Usuwanie kont Uczestników oraz usuwanie zweryfikowanych aktywności:
      1. W przypadku gdy Uczestnik usunie swoje konto w Stravie lub to konto z innych powodów będzie dezaktywowane, wówczas ten Uczestnik zostanie usunięty z listy aktywnych uczestników wydarzenia.
      2. W przypadku gdy aktywność zapisana w Stravie, mimo że zweryfikowana wcześniej poprawnie, zmieni swój status na inny niż publiczny, to zostanie ona usunięta z listy zweryfikowanych aktywności. Tym samym zostanie odpowiednio zaktualizowana aktualna liczba zaliczonych aktywności dla danego Uczestnika.
      3. Dla każdego z podanych wyżej dwóch przypadków, Organizator wyśle do Uczestnika wiadomość e-mail wraz z odpowiednią informacją, w tym ze wskazaniem powodu usunięcia.
   6. Dodatkowe wskazówki dla udanej weryfikacji:
      1. Przed rozpoczęciem jazdy upewnij się, że GPS działa poprawnie.
      2. Upewnij się, że Twoje urządzenie zapisujące przebieg trasy jest naładowane.
...
### §&nbsp;8 OPŁATY
   ...
   2. Wszelkie koszty związane z uczestnictwem w wydarzeniu, w tym koszty dojazdu, wyposażenia czy wyżywienia, Uczestnicy pokrywają we własnym zakresie.

### §&nbsp;9 NAGRODY

1. Organizator przewiduje nagrody dla Uczestników, którzy ukończą trasę w wyznaczonych okresach czasu.

2. Nagrody sezonowe:
   1. Okres letni (1 czerwca 2025 - 31 sierpnia 2025) - dla pierwszych 100 Uczestników, którzy ukończą i zarejestrują przejazd trasy:
      1. 20 voucherów na 2 godziny korzystania z kortów tenisowych (fundator: Gminny Ośrodek Sportu i Rekreacji w Komornikach).
      2. 40 pakietów zajęć w Studio HighFit (ul. Polna 37, Komorniki), każdy obejmujący 2 godziny zajęć do wykorzystania w dwóch osobnych dniach po wcześniejszym umówieniu (fundator: Studio HighFit).
      3. 30 voucherów o wartości 30 zł brutto do wykorzystania w sklepie Bike Poznań (ul. Grunwaldzka 371, Poznań) - fundator: Wójt Gminy Komorniki.
      4. 10 zestawów gadżetów promocyjnych (fundator: Gminny Ośrodek Sportu i Rekreacji w Komornikach).
   
   2. Okres jesienny (1 września 2025 - 30 listopada 2025) - dla pierwszych 40 Uczestników, którzy ukończą i zarejestrują przejazd trasy:
      1. 10 voucherów na 1 godzinę korzystania z krytych kortów tenisowych (fundator: Gminny Ośrodek Sportu i Rekreacji w Komornikach).
      2. 20 voucherów o wartości 30 zł brutto do wykorzystania w sklepie Bike Poznań (fundator: Wójt Gminy Komorniki).
...
3. Nagroda roczna - medal okolicznościowy:
   ...
   2. Okres rywalizacji medalowej rozpoczyna się 1 czerwca 2025 r. o godz. 00:00 i kończy się 29 maja 2026 r. o godz. 23:59. Szczegółowe zasady zaliczania przejazdów do rywalizacji medalowej, w tym twarde terminy zakończenia jazdy oraz przesłania aktywności do Stravy, określa §&nbsp;10 ust. 3 Regulaminu.
   ...
   4. Medale zostaną wręczone w sobotę 30 maja 2026 r. podczas Dni Komornik 2026 (fundator: Gminny Ośrodek Sportu i Rekreacji w Komornikach).
...
6. Zasady odbioru nagród:
   1. Nagrody za okres letni można odbierać w dniach 2-16 września 2025 r.
   2. Nagrody za okres jesienny można odbierać w dniach 2-16 grudnia 2025 r.
   ...
   6. Medale i nagrody roczne zostaną wręczone w sobotę 30 maja 2026 r. podczas Dni Komornik 2026.

7. Wybór nagrody:
   1. O rodzaju nagrody decyduje Uczestnik podczas osobistego odbioru, w ramach dostępnej puli nagród.
   2. Ze względu na ograniczoną liczbę nagród, obowiązuje kolejność zgłoszeń.
   3. Podczas odbioru nagród każdy Uczestnik zostanie zweryfikowany na podstawie adresu e-mail użytego podczas rejestracji.

8. Niewykorzystane nagrody z danego okresu nie przechodzą na kolejny okres.

9. Organizator zastrzega sobie prawo do wprowadzenia dodatkowych nagród specjalnych.
...
### §&nbsp;10 WYNIKI
   ...
   3. Szczególne zasady rywalizacji o medal okolicznościowy:
      1. W celu zapewnienia, że ceremonia wręczenia medali w dniu 30 maja 2026 r. odbędzie się w oparciu o ostateczne i kompletne wyniki, dla rywalizacji o medal okolicznościowy obowiązują twarde, nieprzekraczalne terminy określone poniżej.
      2. Do rywalizacji o medal zaliczane są wyłącznie przejazdy, które łącznie spełniają następujące warunki:
         1. Sama jazda (aktywność rowerowa) zakończyła się najpóźniej w piątek 29 maja 2026 r. o godz. 23:59 czasu lokalnego (Europe/Warsaw).
         2. Aktywność została przesłana do serwisu Strava i jest widoczna dla systemu Komornicka 100 najpóźniej w piątek 29 maja 2026 r. o godz. 23:59 czasu lokalnego (Europe/Warsaw).
      ...
      5. Ostateczna lista Uczestników uprawnionych do otrzymania medalu zostanie zamknięta i opublikowana na stronie [komornicka100.pl](https://komornicka100.pl) w sobotę 30 maja 2026 r., przed ceremonią wręczenia medali.
...
### §&nbsp;11 KLAUZULA INFORMACYJNA
   ...
   1. Administratorem danych osobowych Uczestnika, w postaci imienia, nazwiska, wieku, adresu e-mail oraz dobrowolnie udostępnionych danych z aplikacji Strava jest:
   ...
   2. Dane osobowe Uczestników przetwarzane będą w celu:
      ...
      1. Organizacji i przeprowadzenia Wydarzenia "Komornicka 100" zgodnie z jego Regulaminem (podstawa prawna: art. 6. ust. 1 lit. b RODO);
      2. Informowania o przebiegu Wydarzenia i jego wynikach na stronach internetowych i mediach społecznościowych Organizatorów na podstawie dobrowolnie wyrażonej zgody (art. 6 ust. 1 lit. a RODO);
      3. Wykonania ciążących na Organizatorze obowiązków prawnych (podstawa prawna: art. 6. ust. 1 lit c RODO);
      4. Rozpatrzenia ewentualnych reklamacji i dochodzenia ewentualnych roszczeń związanych z udziałem w Wydarzeniu (podstawa prawna: art. 6. ust. 1 lit. f RODO).

   3. Podanie danych osobowych przez Uczestnika jest dobrowolne, lecz niezbędne do wzięcia udziału w wydarzeniu, a w przypadku spełnienia wszystkich wymagań, o których mowa w  §&nbsp;10 Regulaminu również do otrzymania nagrody, a konsekwencją niepodania danych osobowych będzie brak możliwości udziału w wydarzeniu i otrzymania nagrody.
   4. Odbiorcą danych osobowych Uczestnika mogą być:

      1. Podmioty upoważnione z mocy przepisów prawa;
      2. Inne podmioty, którym Organizator powierza przetwarzanie danych osobowych w związku z organizacją Wydarzenia, na podstawie umów powierzenia i zgodnie z wymogami art. 28 RODO;
      3. W zakresie publikacji wyników: nieograniczony krąg odbiorców.

   5. Administrator będzie przechowywać dane osobowe przez czas trwania Wydarzenia oraz kolejnych edycji wydarzenia, w których Uczestnik bierze udział na podstawie jednorazowej rejestracji, o której mowa w §&nbsp;6 ust. 3, a po zakończeniu udziału Uczestnika w wydarzeniu - do upływu okresu przedawnienia roszczeń wynikających z udziału w Wydarzeniu, chyba że z przepisów prawa wynikał będzie obowiązek dłuższego przechowywania danych, to wówczas dane będą przechowywane, aż do upływu tego okresu.

   6. Uczestnikowi przysługuje prawo do:

      1. Żądania od Administratora dostępu do swoich danych, ich sprostowania oraz otrzymania kopii tych danych, jak również otrzymania pełnej informacji o ich przetwarzaniu;
      2. Żądania od Administratora usunięcia danych lub ograniczenia ich przetwarzania (przy czym może to spowodować wykluczenie Uczestnika z udziału w Wydarzeniu), a także wniesienia sprzeciwu wobec ich przetwarzania; Administrator poinformuje Uczestnika o uwzględnieniu jego żądania lub poda przyczyny, dla których żądanie nie może być zrealizowane;
...
### §&nbsp;13 POSTANOWIENIA KOŃCOWE
   ...
   3. Zabrania się używania przedmiotów, które mogą być niebezpieczne dla innych. W trakcie aktywności zabrania się stosowania środków odurzających, dopingowych, nielegalnych substancji oraz napojów alkoholowych.
